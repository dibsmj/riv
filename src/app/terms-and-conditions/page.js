...
const TermsCondition = dynamic(() => import("@/pagecomponent/TermsConditions"));
...
export default function Termsconditions() {
  const data = {
    headerTitle: "rivexa - Terms Conditions",
  };
  return <TermsCondition propsData={data} />;
}
