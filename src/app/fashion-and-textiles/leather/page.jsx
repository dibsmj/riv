...
const FHTLeather = dynamic(() =>
  import("@/pagecomponent/FHTSubcategoryPages/Leather")
);
...
export const metadata = async () => {
  ...
  const canonicalUrl = `${protocol}://${host}/fashion-and-textiles/leather`;
  return {
    title: "Custom Leather Products Manufacturer and Suppliers",
    description:
      "Luxurious leather essentials from rivexa: jackets, shoes, gloves, bottom wear, bags, wallets, belts & travel accessories",
    keywords:
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: "Leather",
        item: `${process.env.NEXT_PUBLIC_APP_ROOT_URL}/fashion-and-textiles/leather`,
      },
    ],
  };
  return (
