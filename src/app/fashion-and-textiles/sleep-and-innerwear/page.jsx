...
const FHTSleepAndInnerwear = dynamic(() =>
  import("@/pagecomponent/FHTSubcategoryPages/SleepAndInnerWear")
);
...
export const metadata = async () => {
  ...
  const canonicalUrl = `${protocol}://${host}/fashion-and-textiles/sleep-and-innerwear`;
  return {
    title: "Sleep and Innerwear Products Manufacturer and Suppliers",
    description:
      "Shop bulk boxers, vests, panties, bras, and pyjama sets at rivexa for top-quality sleep and innerwear textiles with unbeatable prices and fast sourcing.",
    keywords:
...
export default function Fashionandtextiles() {
  const data = {
    headerTitle: "rivexa - Sleep And Innerwear",
  };
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Sleep And Innerwear",
        item: `${process.env.NEXT_PUBLIC_APP_ROOT_URL}/fashion-and-textiles/sleep-and-innerwear`,
      },
    ],
  };
  return (
    <>
      ...
      />
      <FHTSleepAndInnerwear propsData={data} />
    </>
  );
}
