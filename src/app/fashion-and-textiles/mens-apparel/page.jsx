...
const FHTMensApparel = dynamic(() =>
  import("@/pagecomponent/FHTSubcategoryPages/MensApparel")
);
...
export const metadata = async () => {
  ...
  const canonicalUrl = `${protocol}://${host}/fashion-and-textiles/mens-apparel`;
  return {
    title: "Mens Apparel Manufacturers & Clothing Suppliers",
    description:
      "Connect with Indian manufacturers for shirts, activewear, outerwear, sleepwear, trousers, jeans and other premium men's apparel sourcing on rivexa: largest B2B export marketplace",
    keywords:
...
export default function Fashionandtextiles() {
  const data = {
    headerTitle: "rivexa - Mens Apparel",
  };
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: "Mens Apparel",
        item: `${process.env.NEXT_PUBLIC_APP_ROOT_URL}/fashion-and-textiles/mens-apparel`,
      },
    ],
  };
  return (
