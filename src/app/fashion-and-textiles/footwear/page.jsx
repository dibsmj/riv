...
const FHTFootwear = dynamic(() =>
  import("@/pagecomponent/FHTSubcategoryPages/Footwear")
);
...
export const metadata = async () => {
  ...
  const canonicalUrl = `${protocol}://${host}/fashion-and-textiles/footwear`;
  return {
    title: "Custom Footwear Manufacturers and Suppliers",
    description:
      "Explore diverse footwear with rivexa's comprehensive collection: formal, men's & women's, children's, sports, leather & sustainable options. ",
    keywords:
  ...
  const jsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: "Footwear",
        item: `${process.env.NEXT_PUBLIC_APP_ROOT_URL}/fashion-and-textiles/footwear`,
      },
    ],
  };
  return (
